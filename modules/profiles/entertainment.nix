...
in
{
  ...
  # jellyfin-media-player desktop app from home/jerzy/entertainment.nix.
  #
  ...
  options.profiles.entertainment = {
    enable = lib.mkEnableOption ''
      the entertainment profile: the Prowlarr/Radarr/qBittorrent/Jellyfin media
      stack plus the media players that go with it
    '';
